-- Largely taken from the mana_beam_wide particle
local ray = {}
...
return { generator = function()
	...
	return {
		life = 14,
		size = rng.range(6, 9), sizev = -0.1, sizea = 0,
		...
		vel = rng.percent(40) and 6 or 0, velv = -0.1, vela = 0.01,
